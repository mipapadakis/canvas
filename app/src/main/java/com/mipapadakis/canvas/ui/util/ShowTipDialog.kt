...
class ShowTipDialog(view: View, private val iconId: Int){
    ...
    companion object{
        ...
        fun showCanvasBackgroundTipDialog(context: Context){
            val dialog = Dialog(context)
            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE)
            dialog.setCancelable(true)
            dialog.setContentView(R.layout.dialog_tip)
            dialog.findViewById<ImageView>(R.id.tip_dialog_icon).setImageResource(R.drawable.logo_outlined)
            dialog.findViewById<TextView>(R.id.tip_dialog_title).text = context.getString(R.string.canvas_background_tip_title)
            dialog.findViewById<TextView>(R.id.tip_dialog_subtitle).text = context.getString(R.string.canvas_background_tip_subtitle)
            dialog.findViewById<TextView>(R.id.tip_dialog_description).text = context.getString(R.string.canvas_background_tip_description)
            val closeBtn =  dialog.findViewById<Button>(R.id.tip_dialog_close_button)
            closeBtn.text = context.getString(R.string.ok)
            closeBtn.setOnClickListener{ dialog.dismiss() }
            dialog.show()
