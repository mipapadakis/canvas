...
class BrushToolMenu(owner: LifecycleOwner, brushLayout: View){
    ...
    init {
        ...
        val currentSize = CanvasActivityData.getBrushSize().toInt().toString() + "px"
        toolBrushSizeBtn.text = currentSize
        toolBrushTypeBtn.setImageResource(CanvasActivityData.brushType)
        ...
        toolBrushSizeBtn.setOnClickListener {
            ...
            val newSize = CanvasActivityData.getBrushSize().toInt().toString() + "px"
            toolBrushSizeBtn.text = newSize
            editorSizeSeekbar.progress = CanvasActivityData.getBrushSize().toInt()
        ...
        editorSizeSeekbar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener{
            ...
            override fun onProgressChanged(seekbar: SeekBar?, progress: Int, fromUser: Boolean) {
                ...
                toolBrushSizeBtn.text = newSize
                CanvasActivityData.setBrushSize(brushLayout.resources, progress.toFloat())
            }
        })
        ...
        editorBrushTypeBrush.setOnClickListener {
            CanvasActivityData.setBrushOrPencilType(CanvasActivityData.BRUSH_TYPE_BRUSH)
            toolBrushTypeBtn.setImageResource(CanvasActivityData.BRUSH_TYPE_BRUSH)
            toolBrushSizeBtn.visibility = View.VISIBLE
        }
        editorBrushTypePencil.setOnClickListener {
            CanvasActivityData.setBrushOrPencilType(CanvasActivityData.BRUSH_TYPE_PENCIL)
            toolBrushTypeBtn.setImageResource(CanvasActivityData.BRUSH_TYPE_PENCIL)
            toolBrushSizeBtn.visibility = View.GONE
        }
        editorBrushTypePattern1.setOnClickListener {
            CanvasActivityData.setBrushType(brushLayout.resources, CanvasActivityData.BRUSH_TYPE_PATTERN_1)
            toolBrushTypeBtn.setImageResource(CanvasActivityData.BRUSH_TYPE_PATTERN_1)
            toolBrushSizeBtn.visibility = View.VISIBLE
        }
        editorBrushTypePattern2.setOnClickListener {
            CanvasActivityData.setBrushType(brushLayout.resources, CanvasActivityData.BRUSH_TYPE_PATTERN_2)
            toolBrushTypeBtn.setImageResource(CanvasActivityData.BRUSH_TYPE_PATTERN_2)
            toolBrushSizeBtn.visibility = View.VISIBLE
        }
        editorBrushTypePattern3.setOnClickListener {
            CanvasActivityData.setBrushType(brushLayout.resources, CanvasActivityData.BRUSH_TYPE_PATTERN_3)
            toolBrushTypeBtn.setImageResource(CanvasActivityData.BRUSH_TYPE_PATTERN_3)
            toolBrushSizeBtn.visibility = View.VISIBLE
        }
        editorBrushTypePattern4.setOnClickListener {
            CanvasActivityData.setBrushType(brushLayout.resources, CanvasActivityData.BRUSH_TYPE_PATTERN_4)
            toolBrushTypeBtn.setImageResource(CanvasActivityData.BRUSH_TYPE_PATTERN_4)
            toolBrushSizeBtn.visibility = View.VISIBLE
        }
        editorBrushTypePattern5.setOnClickListener {
            CanvasActivityData.setBrushType(brushLayout.resources, CanvasActivityData.BRUSH_TYPE_PATTERN_5)
            toolBrushTypeBtn.setImageResource(CanvasActivityData.BRUSH_TYPE_PATTERN_5)
            toolBrushSizeBtn.visibility = View.VISIBLE
        }
        setTipDialogs()
    }
