...
class OpacityEditorHelper() {
    companion object {
        private var opacityBitmap = CanvasActivityData.opacityBitmapForOpacityEditor //png_grid -> transparent
        ...
        fun updateSeekbar(seekbar: SeekBar) {
            ...
            val colorWithFullAlpha = Color.argb(255, Color.red(CanvasActivityData.paint.color), Color.green(CanvasActivityData.paint.color), Color.blue(CanvasActivityData.paint.color))
